...
//          cache the image padding information
                    self.offsetPadding = {
                            top: parseInt($img.css('padding-top'),0),
                            left: parseInt($img.css('padding-left'),0),
                            right: parseInt($img.css('padding-right'),0),
                            bottom: parseInt($img.css('padding-bottom'),0)
                    };
/*
...
//                  console.log("drag");
                        ev.preventDefault();
                        if(! self.vCenter.x > ((width / 2) * this.options.zoom) - (-width + $(window).width()))
                        {
                            self.vCenter.x = self.dragXorg - ev.deltaX/self.options.zoom;
                        }
                        
                        if(! self.vCenter.y > ((height / 2) * this.options.zoom) - (-height + $(window).height()))
                        {
        ...
        update: function() {
            if (this.ready) {
                ...
                if (zoom < 1) {
                    ...
                    if (Math.round(half_height - this.vCenter.y * zoom) < -height + $(window).height()) {
                        console.log("zTop TOO SMALL");
                        zTop = -height + $(window).height();
                    }
                    else {
                        zTop = Math.round(half_height - this.vCenter.y * zoom);
                    }

                    if (Math.round(half_width - this.vCenter.x * zoom) < -width + $(window).width()) {
                        zLeft = -width + $(window).width();
                        console.log("zLeft TOO SMALL");
                    ...
                    console.log("zTop",zTop);
                    console.log("zLeft",zLeft);
                    ...
                    console.log("vCenter.y", this.vCenter.y);
                    console.log("vCenter.x", this.vCenter.x);
/*
 ...
 */
                    ...
                    else if (Math.round(half_width - this.vCenter.x * zoom) < -width + $(window).width()) {

                        console.log("vCenter.x", this.vCenter.x)
                        zLeft = -width + $(window).width();
                        this.vCenter.x = ((width / 2) * zoom) - zLeft;
                        console.log("vcenter.x LIMITED");
                    }
                    if (zTop > 0) {
                        this.vCenter.y = half_height/zoom;
                        zTop = 0;
                    } 
                    else if (Math.round(half_height - this.vCenter.y * zoom) < -height + $(window).height()) {
                        console.log("vCenter.y", this.vCenter.y)
                        zTop = -height + $(window).height();
                        this.vCenter.y = ((height / 2) * zoom) - zTop;
                        console.log("vcenter.y LIMITED");
                ...
                console.log("xt", xt);
                console.log("yt", yt);
                console.log("xt check", -iwidth + $(window).width());
                console.log("yt check", -iheight + $(window).height());

                if (xt < -iwidth + $(window).width())
                {
                    xt = -iwidth + $(window).width();
                    console.log("xt over");
                }
                else if(xt > 0)
                {
                ...
                if (yt < -iheight + $(window).height())
                {                   
                    if(this.vCenter.yMax === undefined || this.vCenter.yMax === null)
                        {
                            this.vCenter.yMax = this.vCenter.y;
                            console.log("yMax",this.vCenter.yMax);
                        }
                    yt = -iheight + $(window).height();
                    console.log("yt over");
                }
                else if(yt > 0)
                {
